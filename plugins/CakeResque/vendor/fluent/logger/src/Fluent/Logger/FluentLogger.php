...
class FluentLogger extends BaseLogger
{
    ...
    const SOCKET_TIMEOUT     = 0;
    const SOCKET_MICRO_TIMEOUT     = 100000;
    ...
    protected $options = array(
        ...
        "socket_micro_timeout"  => self::SOCKET_MICRO_TIMEOUT,
    ...
    protected function connect()
    {
        ...
        stream_set_timeout($socket, $this->getOption("socket_timeout", self::SOCKET_TIMEOUT), $this->getOption("socket_micro_timeout", self::SOCKET_MICRO_TIMEOUT));
        $this->socket = $socket;
    }
