	...
	function __cake() {
		...
		if (!empty($result[0])) {
			...
			for ($i = 0; $i < $count; $i++) {
				...
				if ($position === false) {
					$this->__text = str_replace($result[0][$i], $this->__encode('<h4>[b]Model Class:[/b]</h4>' . $this->__highlightCode('<?php ' . $result[2][$i] . '?>')), $this->__text);
				} else {
		...
		if (!empty($result[0])) {
			...
			for ($i = 0; $i < $count; $i++) {
				$position = strpos('<?php', $result[2][$i]);
				if ($position === false) {
					$this->__text = str_replace($result[0][$i], $this->__encode('<h4>[b]Controller Class:[/b]</h4>' . $this->__highlightCode('<?php ' . $result[2][$i] . '?>')), $this->__text);
				} else {
		...
		if (!empty($result[0])) {
			...
			for ($i = 0; $i < $count; $i++) {
				$position = strpos('<?php', $result[2][$i]);
				if ($position === false) {
					$this->__text = str_replace($result[0][$i], $this->__encode('<h4>[b]Helper Class:[/b]</h4>' . $this->__highlightCode('<?php ' . $result[2][$i] . '?>')), $this->__text);
				} else {
		...
		if (!empty($result[0])) {
			...
			for ($i = 0; $i < $count; $i++) {
				$position = strpos('<?php', $result[2][$i]);
				if ($position === false) {
					$this->__text = str_replace($result[0][$i], $this->__encode('<h4>[b]Component Class:[/b]</h4>' . $this->__highlightCode('<?php ' . $result[2][$i] . '?>')), $this->__text);
				} else {
		...
		if (!empty($result[0])) {
			...
			for ($i = 0; $i < $count; $i++) {
				$position = strpos('<?php', $result[2][$i]);
				if ($position === false) {
					$this->__text = str_replace($result[0][$i], $this->__encode('<h4>[b]DataSource Class:[/b]</h4>' . $this->__highlightCode('<?php ' . $result[2][$i] . '?>')), $this->__text);
				} else {
		...
		if (!empty($result[0])) {
			...
			for ($i = 0; $i < $count; $i++) {
				$position = strpos('<?php', $result[2][$i]);
				if ($position === false) {
					$this->__text = str_replace($result[0][$i], $this->__encode('<h4>[b]Behavior Class:[/b]</h4>' . $this->__highlightCode('<?php ' . $result[2][$i] . '?>')), $this->__text);
				} else {
	...
	function __code() {
		...
		if (!empty($result[0])) {
			...
			for ($i = 0; $i < $count; $i++) {
				$position = strpos('<?php', $result[2][$i]);
				if ($position === false) {
					$this->__text = str_replace($result[0][$i], $this->__encode('<h4>[b]PHP Snippet:[/b]</h4>' . $this->__highlightCode('<?php ' . $result[2][$i] . '?>')), $this->__text);
				} else {
