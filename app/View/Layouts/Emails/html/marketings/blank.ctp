...
<div about="Email" aria-disabled="true" style='width:700px'>
	...
	<h3> <?php
	if ($email['EmailMarketing']['type'] == 0) {
		echo 'SEND ALL USERS';
	} elseif ($email['EmailMarketing']['type'] == 1)  {
		echo 'GIFTCODE';
	} else {
		echo "NEW MARKETING EMAIL TYPE";
	}
	?> </h3>

	<span style='text-decoration: underline'>Email Title: </strong></span>
