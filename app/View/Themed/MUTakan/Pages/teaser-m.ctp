...
<head>
    ...
    echo $this->Html->css($webroot . '/css/mini-m.css');
    echo $this->Html->css($webroot . '/css/teaser-m.css');
...
<!--            <a class="logo" href="#" title="#">#</a>-->
        ...
        <div class="box-game " id="box-game">
            <div class="box-gameL cf">
                ...
                <div class="game-container">
                    <div class="game-message">
                        <div class="box-txt">
                            ...
                            <form>
                                <input type="email" class="ip-email" value="" placeholder="Để lại email" required spellcheck="false">
                                <div class="lower">
...
<!--                    </table>-->
                ...
                <div role="tabpanel" class="tab-pane" id="thuong">
                    <div class="box-thuong">
                        <img src="http://cdn.smobgame.com/newfolder/dautruongpk/teaser/gt2.png">
    ...
    <?php echo $this->element('websitem_giftcode_script'); ?>
    <script>
        $('#email1').modal('show');
        ...
        $('.btn-register').bind('click touchstart', function(){
            var score = 0;
        ...
        $('.btnluu').bind('click touchstart', function(){
