...
<div class="games index">
	...
	<tr>
		...
		<th><?php echo $this->Paginator->sort('game_price'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($product['Product']['game_price']); ?></td>
		<td><?php echo h($product['Product']['description']); ?>&nbsp;</td>
		<td class="actions btn-group">
			<?php echo $this->Html->link('Sửa', array('action' => 'edit', $product['Product']['id']), array('class' => 'btn btn-mini')); ?>
			<?php echo $this->Form->postLink('Xóa', array('action' => 'delete', $product['Product']['id']), array('class' => 'btn btn-mini'), sprintf('Are you sure you want to delete # %s?', $product['Product']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
