...
<?php
	...
	echo $this->Form->input('type', array('type' => 'text', 'value' => 'Consumable', 'disabled' => 'disabled'));
	echo $this->Form->input('productid', array('label' => 'Product ID - trên Apple <span class="muted">(Optional)</span>'));
...
<?php
	...
	echo $this->Form->input('game_price', array('type' => 'text'));
	echo $this->Form->input('platform_price', array('type' => 'text', 'label' => 'Platform Price <span class="muted">(Optional)</span>'));
	echo $this->Form->input('payment_type', array('type' => 'text'));
?>
	</div>
<?php
echo $this->Form->end();
