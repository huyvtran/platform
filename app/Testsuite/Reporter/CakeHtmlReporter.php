	...
	protected function _getStackTrace(Exception $e) {
		...
		foreach ($trace as $frame) {
			if (isset($frame['file']) && isset($frame['line'])) {
				...
				$out[] = '<div style = "margin:0;clear:both">' . '<div style = "width:240px;margin:0;float:left;">' . $basename . '</div>' . '<div style = "float:left;margin:0;width:70px;"><span style = "color:#999;font-weight:normal;font-size:12px">line</span> ' . $frame['line'] . ' </div> <span style = "color:#999;font-weight:normal;font-size:12px">in</span> ' . $dirname . '\</div>';
